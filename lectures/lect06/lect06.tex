...
\begin{titledslide}{Acknowledgement}
  ...
  \item These slides are adapted from ones originally created by
    \href{https://www.dpag.ox.ac.uk/team/rui-ponte-costa}{Rui Ponte
      Costa} and later edited by Edwin Simpson, Wei-Hong Li and James Cussens. 
  \end{itemize}
...
\begin{titledslide}{Non-saturating activation functions for deep learning}
  ...
  \item ReLU and its variants are popular choices. But note that plain
...
\begin{titledslide}{Dealing with overfitting}
  ...
  \begin{itemize}
  \item Neural networks often have many parameters (e.g.\ GPT-5 has
    perhaps about 1.5 trillion!) so overfitting is an issue.
...
\begin{titledslide}{Dropout}
  ...
  \begin{itemize}
  \item \emph{Dropout} is where, during training, we randomly turn off
...
\begin{titledslide}{We're missing out a lot, as ever}
  ...
  \item \dots for example, \emph{transformers} using \emph{attention}.
